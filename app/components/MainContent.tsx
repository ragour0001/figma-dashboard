        ...
        >
          ...
          >
            <defs>
              ...
              <radialGradient
                id="paint1_radial_607_14728"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(28.8 44.4) rotate(-45) scale(12.7279)"
              >
                <stop stopColor="#FF8A65" />
                <stop offset="1" stopColor="#FF5722" />
              </radialGradient>
              <linearGradient
                id="paint2_linear_607_14728"
                x1="29.387"
                y1="52.074"
                x2="29.387"
                y2="36.796"
              ...
              <radialGradient
                id="paint4_radial_607_14728"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(38.55 54.15) rotate(-45) scale(12.7279)"
              >
                <stop stopColor="#FF8A65" />
                <stop offset="1" stopColor="#FF5722" />
              </radialGradient>
              <radialGradient
                id="paint5_radial_607_14728"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(39.137 61.824) rotate(-45) scale(12.7279)"
              >
                <stop stopColor="#FFE0B2" />
                <stop offset="1" stopColor="#FFCC02" />
              </radialGradient>
              <linearGradient
                id="paint6_linear_607_14728"
                x1="44.266"
                y1="38.32"
                x2="44.266"
                y2="20.29"
              ...
              <radialGradient
                id="paint7_radial_607_14728"
                cx="0"
                cy="0"
                r="1"
                gradientUnits="userSpaceOnUse"
                gradientTransform="translate(52.6 20.3) rotate(135) scale(25.456)"
              >
                <stop stopColor="#64B5F6" />
                <stop offset="1" stopColor="#1565C0" />
              </radialGradient>
              <filter
                id="filter0_i_607_14728"
                x="26.3086"
                y="20.2785"
                width="35.9157"
                height="36.004"
              ...
              >
                ...
                <feBlend
                  mode="normal"
                  in2="shape"
                  result="effect1_innerShadow_607_14728"
                />
              </filter>
            </defs>
            <path
              d="M33.1862 36.796C35.1362 36.0778 37.0325 37.9741 36.3143 39.9258L32.0617 51.486C31.9676 51.7421 31.8105 51.9704 31.6049 52.1499C31.3993 52.3293 31.1519 52.4541 30.8854 52.5127C30.6189 52.5713 30.3419 52.5618 30.08 52.4852C29.8182 52.4086 29.5798 52.2673 29.3869 52.0743L21.0377 43.725C20.845 43.5321 20.704 43.2938 20.6276 43.0322C20.5512 42.7705 20.5419 42.4938 20.6005 42.2275C20.6591 41.9613 20.7837 41.714 20.9629 41.5086C21.1421 41.3032 21.3701 41.1461 21.6259 41.0519L33.1862 36.796Z"
              fill="url(#paint0_linear_607_14728)"
            />
            <path
